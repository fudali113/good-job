...
import (
	...
	goodjobcontrollerv1alpha1 "github.com/fudali113/good-job/pkg/apis/goodjobcontroller/v1alpha1"
	...
	v1alpha1 "github.com/fudali113/good-job/pkg/client/listers/goodjobcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().Pipelines(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().Pipelines(namespace).Watch(options)
			},
		},
		&goodjobcontrollerv1alpha1.Pipeline{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&goodjobcontrollerv1alpha1.Pipeline{}, f.defaultInformer)
}
