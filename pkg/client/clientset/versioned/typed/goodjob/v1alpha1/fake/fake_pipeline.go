...
var pipelinesResource = schema.GroupVersionResource{Group: "goodjob.k8s.io", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "goodjob.k8s.io", Version: "v1alpha1", Kind: "Pipeline"}
