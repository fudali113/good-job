...
var jobsResource = schema.GroupVersionResource{Group: "goodjob.k8s.io", Version: "v1alpha1", Resource: "jobs"}

var jobsKind = schema.GroupVersionKind{Group: "goodjob.k8s.io", Version: "v1alpha1", Kind: "Job"}
