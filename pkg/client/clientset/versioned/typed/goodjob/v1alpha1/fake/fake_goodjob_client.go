...
import (
	v1alpha1 "github.com/fudali113/good-job/pkg/client/clientset/versioned/typed/goodjob/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeGoodjobV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeGoodjobV1alpha1) RESTClient() rest.Interface {
