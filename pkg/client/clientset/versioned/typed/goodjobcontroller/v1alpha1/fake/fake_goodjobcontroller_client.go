...
import (
	v1alpha1 "github.com/fudali113/good-job/pkg/client/clientset/versioned/typed/goodjobcontroller/v1alpha1"
...
func (c *FakeSamplecontrollerV1alpha1) Pipelines(namespace string) v1alpha1.PipelineInterface {
